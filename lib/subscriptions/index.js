...
exports.mirrorSubscriptionsFollowed = functions.database.ref('/following/{follower_id}/{followed_id}')
...
exports.mirrorSubscriptionsUnfollowed = functions.database.ref('/following/{follower_id}/{followed_id}')
